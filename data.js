  ...
  elementary.groups.push(
    ...
    },
    {
      ...
      questions: [
        ...
        { id: "e5-06", type: "meaning-choice", direction: "ja-vi", prompt: "約束", choices: ["cuộc hẹn", "kế hoạch", "ý kiến", "câu hỏi"], answers: ["cuộc hẹn"], explanation: "cuộc hẹn は「約束・予約」です。", answerLanguage: "vi" },
      ...
      groups: [
        ...
        },
        {
          ...
          questions: [
            ...
            { id: "b13-05", type: "meaning-choice", direction: "vi-ja", prompt: "tái chế", choices: ["再利用する", "廃棄する", "製造する", "輸入する"], answers: ["再利用する"], explanation: "tái chế は「リサイクルする」です。" },
